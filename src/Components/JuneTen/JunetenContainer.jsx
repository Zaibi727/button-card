		...
		this.state = {
			...
			dataItems: [
				...
				},
				{
					...
					buttonIcon: <FaSuitcase/>,
					cardHeaderIcon: <IoDesktop/>,
					cardHeaderLabel: 'Agriculture University',
					currencyIcon: <GrCurrency/>,
					AmountLabel: 'Amount',
					RentLabel: 'Monthly Rent',
					clockIcon: <RiTimeFill/>,
